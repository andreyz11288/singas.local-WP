...
<?php get_header(); ?>
<div class="route-contact-us">
    <div class="fixed-container" bis_skin_checked="1" style="transform: translate3d(0px, 0px, 0px); transition-duration: 500ms;">
        <div class="container home" bis_skin_checked="1">
            <div id="contact-section1" class="section section1 pr df fdc section-no-padding active" is_contact_page="1">
                <canvas id="binary-system2" class="binary-system"></canvas> 
                <div class="blog-logo" bis_skin_checked="1">
                ...
                <div class="absolute-c-logo" bis_skin_checked="1">
                    <div class="scetch-blog" bis_skin_checked="1">
                        <div data-v-4e6cd574="" class="wrapper" bis_skin_checked="1">
                            <div data-v-4e6cd574="" class="text-block" bis_skin_checked="1">
                ...
                <div data-v-3d1e6cee="" class="footer-inner" bis_skin_checked="1">
                    ...
                    <div data-v-3d1e6cee="" class="social-inner" bis_skin_checked="1">
                        <div data-v-21aaaca5="" data-v-3d1e6cee="" class="social-media" bis_skin_checked="1">
                            <div data-v-21aaaca5="" class="social-media-icon" bis_skin_checked="1">
                                <a data-v-21aaaca5="" href="<?php the_field('linck_1_social-media', 7) ?>" target="_blank" class="soc-mod-1">
                                    <img data-v-21aaaca5="" src="<?php the_field('img_1_social-media', 7) ?>" alt="" class="social-media-img">
                                </a>
                            </div> 
                            <div data-v-21aaaca5="" class="social-media-icon" bis_skin_checked="1">
                                <a data-v-21aaaca5="" href="<?php the_field('linck_1_social-media', 7) ?>" target="_blank" class="soc-mod-2">
                                    <img data-v-21aaaca5="" src="<?php the_field('img_2_social-media', 7) ?>" alt="" class="social-media-img">
                                </a>
                            </div> 
                            <div data-v-21aaaca5="" class="social-media-icon" bis_skin_checked="1">
                                <a data-v-21aaaca5="" href="<?php the_field('linck_1_social-media', 7) ?>" target="blanck" class="soc-mod-3">
                                    <img data-v-21aaaca5="" src="<?php the_field('img_3_social-media', 7) ?>" alt="" class="social-media-img">
                                </a>
                            </div> 
                            <div data-v-21aaaca5="" class="social-media-icon" bis_skin_checked="1">
                                <a data-v-21aaaca5="" href="<?php the_field('linck_1_social-media', 7) ?>" target="_blank" class="soc-mod-4">
                                    <img data-v-21aaaca5="" src="<?php the_field('img_4_social-media', 7) ?>" alt="" class="social-media-img twitter">
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        <div  id="contact-section2" class="section section2 section-template pr df fdc jcsb active" is_contact_page="1">
            <canvas id="binary-system" class="binary-system" width="1476" height="953"></canvas> 
            <div bis_skin_checked="1">
                ...
                <div class="absolute-c-logo" bis_skin_checked="1">
                    <div class="scetch-blog" bis_skin_checked="1">
                        <div data-v-4e6cd574="" class="wrapper" bis_skin_checked="1">
                            <div data-v-4e6cd574="" class="letters-inner" bis_skin_checked="1"><!----></div> 
                            <div data-v-4e6cd574="" class="text-block" bis_skin_checked="1">
                                <div data-v-4e6cd574="" class="top-text-wrapper" bis_skin_checked="1">
                                    <div data-v-3a0f674e="" data-v-4e6cd574="" class="top-text" bis_skin_checked="1">
                                        <div data-v-3a0f674e="" class="mobile-text active-text" bis_skin_checked="1">
        ...
        <div  id="contact-section3" class="section section3 section-template pr df fdc jcsb active" is_contact_page="1">
            <canvas id="binary-system" class="binary-system" width="1476" height="953"></canvas> 
            <div class="blog-logo" bis_skin_checked="1">
                <div data-v-6f59b697="" class="inner" bis_skin_checked="1">
                    <img data-v-6f59b697="" src="<?php bloginfo('template_url'); ?>/assets/img/logos.svg" alt="logo" class="super-img">
...
<div class="global-scroll" bis_skin_checked="1">
  <div class="scroll-indicator" bis_skin_checked="1" style="transform: translate3d(0px, 0px, 0px); transition-duration: 500ms;"></div>
</div>
