var canvas = document.getElementById('binary-system')
var canvas2 = document.getElementById('binary-system2')
...
var draw2 = () => {
  ...
  for (let numberElement of numberElementCollector.get()) {
    ctx2.font = numberElement.size / 1.5 + 'px arial black'
    ctx2.textBaseline = 'bottom'
    ctx2.textAlign = 'left'
    ctx2.fillText(numberElement.value, numberElement.x, numberElement.y)
  }
